...
export const getApiV1AgentTokenResponseTransformer = async (
  data: any,
): Promise<GetApiV1AgentTokenResponse> => {
...
export const postApiV1AgentTokenResponseTransformer = async (
  data: any,
): Promise<PostApiV1AgentTokenResponse> => {
  if (data.expiresAt) {
...
export const getApiV1RevenueSummaryResponseTransformer = async (
  data: any,
): Promise<GetApiV1RevenueSummaryResponse> => {
  if (data.asOf) {
...
export const getApiV1RevenueBusinessResponseTransformer = async (
  data: any,
): Promise<GetApiV1RevenueBusinessResponse> => {
  data.data = data.data.map((item: any) => {
    if (item.launchedAt) {
      item.launchedAt = new Date(item.launchedAt)
    }
    return item
  })
  return data
...
export const getApiV1RevenueBusinessBySlugResponseTransformer = async (
  data: any,
): Promise<GetApiV1RevenueBusinessBySlugResponse> => {
...
export const getApiV1OnboardingResponseTransformer = async (
  data: any,
): Promise<GetApiV1OnboardingResponse> => {
  if (data.browserVerifiedAt) {
    data.browserVerifiedAt = new Date(data.browserVerifiedAt)
  }
  if (data.completedAt) {
...
export const postApiV1OnboardingStepResponseTransformer = async (
  data: any,
): Promise<PostApiV1OnboardingStepResponse> => {
  if (data.browserVerifiedAt) {
    data.browserVerifiedAt = new Date(data.browserVerifiedAt)
  }
  if (data.completedAt) {
...
export const postApiV1OnboardingVerifyStartResponseTransformer = async (
  data: any,
): Promise<PostApiV1OnboardingVerifyStartResponse> => {
  data.expiresAt = new Date(data.expiresAt)
  return data
}

export const postApiV1OnboardingVerifyCompleteResponseTransformer = async (
  data: any,
): Promise<PostApiV1OnboardingVerifyCompleteResponse> => {
  if (data.browserVerifiedAt) {
    data.browserVerifiedAt = new Date(data.browserVerifiedAt)
  }
  if (data.completedAt) {
