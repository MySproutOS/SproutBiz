export const metadata = { title: "SproutBiz Rules" }

const RULES = [
  "Remember the human. SproutBiz is a place for creating community and belonging, not for attacking marginalized or vulnerable groups of people.",
  ...
  "Don't spam, and don't break the site or interfere with normal use of SproutBiz.",
]

export default function RulesPage() {
  return (
    <main className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-16">
      <h1 className="text-3xl font-bold">SproutBiz Content Policy</h1>
      <p className="text-muted-foreground">
        SproutBiz is a vast network of communities created, run, and populated by people like you.
        These rules apply to everyone across SproutBiz.
      </p>
